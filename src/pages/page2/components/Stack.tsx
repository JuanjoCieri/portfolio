export default function Stack() {
  return (
    <div className="flex flex-col bg-gray-200 dark:bg-gray-600 rounded-xl shadow-xs shadow-fuchsia-400">
      <div className="flex border border-gray-200 rounded-t-lg items-center justify-center px-4 bg-gray-200 dark:bg-gray-900">
      ...
      <div className="flex flex-row lg:flex-col flex-wrap lg:flex-nowrap p-4 gap-3 bg-white dark:bg-gray-800 border border-gray-200 rounded-b-lg">
